export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', href: "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.18/css/bootstrap-select.min.css"},
    ],
    script: [
      ...
      {src: "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.18/js/bootstrap-select.min.js", body: true},
    ]
  },
